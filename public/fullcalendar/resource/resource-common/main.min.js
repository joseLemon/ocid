...
!function (e, r) {
    ...
    function n(e, t, n, i) {
        if (t) {
            var a = o(n.instances, i), c = s(a, n.defs);
    ...
    function s(e, r) {
        var t = {};
        for (var n in e) for (var o = e[n], s = 0, u = r[o.defId].resourceIds; s < u.length; s++) {
            var i = u[s];
            t[i] = !0
        }
        return t
    ...
    function u(e, r) {
        var t = {};
        for (var n in e) for (var o = void 0; (o = r[n]) && (n = o.parentId);) t[n] = !0;
        return t
    }
    ...
    function p(e) {
        for (var r = ce.length - 1; r >= 0; r--) {
            var t = ce[r], n = t.parseMeta(e);
            if (n) {
                var o = h("object" == typeof e && e ? e : {}, n, r);
                return o._raw = e, o
            }
        }
        return null
    ...
    function y(e, r, t) {
        var n = d(e.sourceDefId), o = String(de++);
        return n.fetch({resourceSource: e, calendar: t, range: r}, function (e) {
            ...
            t.dispatch({type: "RECEIVE_RESOURCE_ERROR", fetchId: o, fetchRange: r, error: e})
        }), se({}, e, {isFetching: !0, latestFetchId: o})
    }

    function E(e, r, t) {
        return r === e.latestFetchId ? se({}, e, {isFetching: !1, fetchRange: t}) : e
    }

    function m(e, t, n, o) {
        void 0 === t && (t = "");
        var s = {}, u = r.refineProps(e, fe, {}, s), i = {}, a = r.processScopedUiProps("event", s, o, i);
        if (u.id || (u.id = pe + he++), u.parentId || (u.parentId = t), u.businessHours = u.businessHours ? r.parseBusinessHours(u.businessHours, o) : null, u.ui = a, u.extendedProps = se({}, i, u.extendedProps), Object.freeze(a.classNames), Object.freeze(u.extendedProps), n[u.id]) ; else if (n[u.id] = u, u.children) {
    ...
    function _(e, r) {
        var t = se({}, e);
        delete t[r];
        for (var n in t) t[n].parentId === r && (t[n] = se({}, t[n], {parentId: ""}));
        return t
    }
    ...
    function O(e, r, t) {
        var n = v(e.resourceSource, r, e.dateProfile, t), o = I(e.resourceStore, r, n, t),
            s = P(e.resourceEntityExpansions, r);
        return se({}, e, {resourceSource: n, resourceStore: o, resourceEntityExpansions: s})
    }

    function x(e, t, n) {
        var o = r.refineProps(t, ve, {}, n), s = o.resourceIds;
        o.resourceId && s.push(o.resourceId), e.resourceIds = s, e.resourceEditable = o.resourceEditable
    }

    function T(e, r, t) {
        var n = r.dateSpan.resourceId, o = t.dateSpan.resourceId;
    ...
    function U(e, r) {
        var t = e.dateSpan.resourceId, n = r.dateSpan.resourceId;
        if (t && n) return (e.component.allowAcrossResources !== !1 || t === n) && {resourceId: t}
    }

    function A(e, r) {
        return e.resourceId ? {resource: r.getResourceById(e.resourceId)} : {}
    }
    ...
    function B(e, t) {
        var n = new Re, o = n.splitProps(se({}, e, {resourceStore: t.state.resourceStore}));
        for (var s in o) {
            var u = o[s];
            if (s && o[""] && (u = se({}, u, {
                eventStore: r.mergeEventStores(o[""].eventStore, u.eventStore),
                eventUiBases: se({}, o[""].eventUiBases, u.eventUiBases)
            })), !r.isPropsValid(u, t, {resourceId: s}, z.bind(null, s))) return !1
        }
        return !0
    }

    function z(e, r) {
        return se({}, r, {constraints: M(e, r.constraints)})
    }
    ...
    function k(e, t) {
        ...
        // TODO: REMINDER THAT I ADDED THIS RETURN
        return;
    ...
    function K(e) {
        ...
        if (t && 10 === t[1].length) {
            var n = new Date(1e3 * parseInt(t[2], 10)), o = new Date(r.config.mockSchedulerReleaseDate || ye);
            if (r.isValidDate(o)) {
                var s = r.addDays(o, -Ee);
                if (s < n) return !0
            }
        }
        // TODO: REMINDER THAT I CHANGED IT TO !0 FRON !1
        return !0
    }
    ...
    function X(e, r, t, n, o, s, u) {
        for (var i = 0; i < e.length; i++) {
            var a = e[i], c = a.group;
            if (c) if (t) {
                var l = r.length, d = n.length;
                if (X(a.children, r, t, n.concat(0), o, s, u), l < r.length) {
                    var f = r[l], p = f.rowSpans = f.rowSpans.slice();
                    p[d] = r.length - l
                }
            } else {
                var h = c.spec.field + ":" + c.value, v = null != s[h] ? s[h] : u;
                r.push({id: h, group: c, isExpanded: v}), v && X(a.children, r, t, n, o + 1, s, u)
            } else if (a.resource) {
                var h = a.resource.id, v = null != s[h] ? s[h] : u;
                r.push({
                    id: h,
                    rowSpans: n,
                    depth: o,
    ...
    function $(e, r) {
        ...
        for (var n in e) {
            var o = e[n];
            t[n] = {resource: o, resourceFields: te(o), children: []}
        }
        for (var n in e) {
            var o = e[n];
            if (o.parentId) {
    ...
    function ee(e, t, n) {
        ...
        if (n.order) for (s = 0; s < t.length; s++) {
            var i = t[s];
            if (i.group) {
        ...
        return o || (o = {group: {value: u, spec: n}, children: []}, t.splice(s, 0, o)), o
    }
    ...
    ***************************************************************************** */
    var oe = function (e, r) {
            return (oe = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (e, r) {
                e.__proto__ = r
            } || function (e, r) {
            ...
            function e() {
                this.buildResourceEventUis = r.memoizeOutput(i, r.isPropsEqual), this.injectResourceEventUis = r.memoize(a)
            }

            return e.prototype.transform = function (e, r, t) {
                if (!r["class"].needsResourceData) return {eventUiBases: this.injectResourceEventUis(e.eventUiBases, e.eventStore.defs, this.buildResourceEventUis(t.resourceStore))}
            }, e
        }(), ae = {id: String}, ce = [], le = 0, de = 0,
        fe = {id: String, title: String, parentId: String, businessHours: null, children: null, extendedProps: null},
        pe = "_fc:", he = 0, ve = {
            resourceId: String, resourceIds: function (e) {
            ...
            return e.prototype.setProp = function (e, r) {
                ...
                this._calendar.dispatch({type: "REMOVE_RESOURCE", resourceId: this._resource.id})
            }, e.prototype.getParent = function () {
                var r = this._calendar, t = this._resource.parentId;
                return t ? new e(r, r.state.resourceSource[t]) : null
            }, e.prototype.getChildren = function () {
                var r = this._resource.id, t = this._calendar, n = t.state.resourceStore, o = [];
                for (var s in n) n[s].parentId === r && o.push(new e(t, n[s]));
                return o
            }, e.prototype.getEvents = function () {
                var e = this._resource.id, t = this._calendar, n = t.state.eventStore, o = n.defs, s = n.instances, u = [];
                for (var i in s) {
                    var a = s[i], c = o[a.defId];
    ...
    r.Calendar.prototype.addResource = function (e, r) {
        ...
        void 0 === r && (r = !0);
        var n, o;
        return e instanceof ge ? (o = e._resource, t = {}, t[o.id] = o, n = t) : (n = {}, o = m(e, "", n, this)), r && this.component.view.addScroll({forcedRowId: o.id}), this.dispatch({
            type: "ADD_RESOURCE",
            resourceHash: n
        }), new ge(this, o)
        ...
        var e = this.state.resourceStore, r = [];
        if (e) for (var t in e) r.push(new ge(this, e[t]));
        return r
    }, r.Calendar.prototype.getTopLevelResources = function () {
        var e = this.state.resourceStore, r = [];
        if (e) for (var t in e) e[t].parentId || r.push(new ge(this, e[t]));
        return r
    ...
    var ye = "2019-06-02", Ee = 372, me = "http://fullcalendar.io/scheduler/license/",
        Se = ["GPL-My-Project-Is-Open-Source", "CC-Attribution-NonCommercial-NoDerivatives"], Ie = {
            position: "absolute",
            "z-index": 99999,
            bottom: "1px",
            left: "1px",
    ...
    l({
        ignoreRange: !0, parseMeta: function (e) {
            ...
            r({rawResources: e.resourceSource.meta})
        }
    }), l({
        parseMeta: function (e) {
            return "function" == typeof e ? e : "function" == typeof e.resources ? e.resources : null
        }, fetch: function (e, t, n) {
            var o = e.calendar.dateEnv, s = e.resourceSource.meta, u = {};
            e.range && (u = {
        ...
        parseMeta: function (e) {
            ...
            var o = e.resourceSource.meta, s = Z(o, e.range, e.calendar);
            r.requestJson(o.method, o.url, s, function (e, r) {
                t({rawResources: e, xhr: r})
            }, function (e, r) {
                n({message: e, xhr: r})
            })
        }
    ...
    var Ce = function (e) {
        function n(t, n) {
            ...
            return o.datesAboveResources = o.opt("datesAboveResources"), o.resourceTextFunc = G(o.opt("resourceText"), o.calendar), n.innerHTML = "", n.appendChild(o.el = r.htmlToElement('<div class="fc-row ' + o.theme.getClass("headerRow") + '"><table class="' + o.theme.getClass("tableGrid") + '"><thead></thead></table></div>')), o.thead = o.el.querySelector("thead"), o
        }
        ...
        return t(n, e), n.prototype.destroy = function () {
            ...
            var o = this.dateEnv;
            return '<th class="fc-resource-cell" data-resource-id="' + e.id + '"' + (n ? ' data-date="' + o.formatIso(n, {omitTime: !0}) + '"' : "") + (t > 1 ? ' colspan="' + t + '"' : "") + ">" + r.htmlEscape(this.resourceTextFunc(e)) + "</th>"
            ...
            r.findElements(this.thead, ".fc-resource-cell").forEach(function (r, o) {
                ...
                var s = e[o];
                n.publiclyTrigger("resourceRender", [{resource: new ge(t.calendar, s), el: r, view: n}])
            })
        }, n
    }(r.Component), _e = function () {
        function e(e, r) {
            this.dayTable = e, this.resources = r, this.resourceIndex = new Oe(r), this.rowCnt = e.rowCnt, this.colCnt = e.colCnt * r.length, this.cells = this.buildCells()
        }

        return e.prototype.buildCells = function () {
            for (var e = this, r = e.rowCnt, t = e.dayTable, n = e.resources, o = [], s = 0; s < r; s++) {
                for (var u = [], i = 0; i < t.colCnt; i++) for (var a = 0; a < n.length; a++) {
                    var c = n[a], l = 'data-resource-id="' + c.id + '"';
                    u[this.computeCol(i, a)] = {date: t.cells[s][i].date, resource: c, htmlAttrs: l}
                }
                o.push(u)
            }
            return o
        ...
        return t(r, e), r.prototype.computeCol = function (e, r) {
            ...
            return [{firstCol: this.computeCol(e, t), lastCol: this.computeCol(r, t), isStart: !0, isEnd: !0}]
        }, r
    }(_e), Pe = function (e) {
        function r() {
            return null !== e && e.apply(this, arguments) || this
        ...
        return t(n, e), n.prototype.getKeyInfo = function (e) {
            var t = e.resourceDayTable, n = r.mapHash(t.resourceIndex.indicesById, function (e) {
        ...
        return e.prototype.joinProps = function (e, r) {
            for (var t = [], n = [], o = [], s = [], u = [], i = [], a = "", c = r.resourceIndex.ids.concat([""]), l = 0, d = c; l < d.length; l++) {
                var f = d[l], p = e[f];
                t.push(p.dateSelectionSegs), n.push(f ? p.businessHourSegs : Te), o.push(f ? p.fgEventSegs : Te), s.push(p.bgEventSegs), u.push(p.eventDrag), i.push(p.eventResize), a = a || p.eventSelection
            }
            return {
            ...
            for (var t = e.resources.length, n = [], o = 0; o < t; o++) for (var s = 0, u = r; s < u.length; s++) {
                var i = u[s];
            ...
            for (var n = e.resources.length, o = {}, s = [], u = !1, i = null, a = 0; a < n; a++) {
                ...
                if (r[n]) for (var p = 0, h = r[n].segs; p < h.length; p++) {
                    var f = h[p];
                    s.push.apply(s, this.transformSeg(f, e, a))
                }
            }
            return {affectedInstances: o, segs: s, isEvent: u, sourceSeg: i}
        }, e
    }(), je = r.createPlugin({
        reducers: [O],
        eventDefParsers: [x],
        eventDragMutationMassagers: [T],
